...
public class AbstractDao<T> {
	...
	public T create(T entity) {
		try {
			...
			System.out.println("Lỗi " + entity.getClass().getSimpleName() + " to DB");
	...
	public T update(T entity) {
		try {
			...
			entityManager.getTransaction().rollback();
			System.out.println("Lỗi update " + entity.getClass().getSimpleName());
			throw new RuntimeException();
		}
	}
	...
	public T delete(T entity) {
		try {
			...
			entityManager.getTransaction().rollback();
			System.out.println("Lỗi delete " + entity.getClass().getSimpleName());
			throw new RuntimeException();
		}
	}
