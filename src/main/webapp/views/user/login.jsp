...
<%@ include file="/common/header.jsp"%>
	 ...
	 <div class="container-fluid px-0">
              ...
              <div class="col-12">
                <div class="mx-auto tm-about-text-container px-3">
                  ...
                  <p class="mb-4">
                    ...
                    This is 100% free Bootstrap v4.4.1 layout. You can modify
                    and adapt this template for your CMS websites. You can use
                    it for commercial or non-commercial work. If you wish to
                    suport
                    <a
                      rel="nofollow"
                      target="_parent"
          ...
          <div
            class="parallax-window parallax-window-2"
            ...
            <div class="row">
              <div class="col-lg-6 mb-5 pt-3">
                <div class="media tm-testimonial">
                  <img
                    class="mr-4 rounded-circle img-fluid"
                    src="img/testimonial-1.jpg"
                    alt="Generic placeholder image"
                  />
                  <p class="media-body pt-3 tm-testimonial-text">
                    Vestibulum non lectus id lacus aliquet porttitor in non
                    nulla. Aenean urna diam, finibys id lorem nec, feugiat
                    convallis dolor. Integer aliquam, eros eget rutrum iaculis.
                  </p>
                </div>
              </div>
              <div class="col-lg-6 mb-5 pt-3">
